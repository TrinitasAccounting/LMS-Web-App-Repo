...
function CourseDetail() {
    ...
    //Using the context hook to update the value on the front end, and then when the page is reloaded at any point later on. Then it will automatically be reloaded
