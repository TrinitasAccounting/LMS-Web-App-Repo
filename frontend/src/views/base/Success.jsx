...
function Success() {
    ...
    // Searching through the URL to get our required properties
    const urlParam = new URLSearchParams(window.location.search)     // this is how we instantiate a search through the URL
    const sessionId = urlParam.get("session_id")                        // then we do a .get("----") to find the property we want by the name it is in the url
                ...
                <div className="container position-relative">
                    <div className="row g-5 align-items-center justify-content-center">
                        ...
                        {orderMessage === "Already Paid" && (
                            <>
                                <div className="col-lg-5">
                                    <h1 className="text-warning">Already Paid </h1>
                                    <p> Hey there, hold on while we process your payment, please do not leave the page.</p>
                                </div>
                                <div className="col-lg-7 text-center">
                                    <img sty src="https://www.icegif.com/wp-content/uploads/2023/07/icegif-1259.gif" className="h-300px h-sm-400px h-md-500px h-xl-700px" alt="" />
